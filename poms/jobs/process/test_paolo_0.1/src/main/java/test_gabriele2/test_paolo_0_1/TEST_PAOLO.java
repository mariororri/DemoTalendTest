...
package test_gabriele2.test_paolo_0_1;
...
/**
 * Job: TEST_PAOLO Purpose: TEST_PAOLO<br>
 * Description: TEST_PAOLO <br>
 * 
 * @author user@talend.com
 * @version 7.2.1.20190620_1446
 * @status
 */
public class TEST_PAOLO implements TalendJob {
	...
	private final String jobName = "TEST_PAOLO";
	private final String projectName = "TEST_GABRIELE2";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(TEST_PAOLO.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static void main(String[] args) {
		final TEST_PAOLO TEST_PAOLOClass = new TEST_PAOLO();

		int exitCode = TEST_PAOLOClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = TEST_PAOLO.class.getClassLoader()
					.getResourceAsStream("test_gabriele2/test_paolo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = TEST_PAOLO.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : TEST_PAOLO");
		}
...
/************************************************************************************************
 * 24887 characters generated by Talend Open Studio for Big Data on the June 11,
 * 2020 4:36:44 PM CEST
 ************************************************************************************************/