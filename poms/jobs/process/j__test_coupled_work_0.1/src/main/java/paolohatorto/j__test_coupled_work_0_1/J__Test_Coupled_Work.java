...
package paolohatorto.j__test_coupled_work_0_1;
...
/**
 * Job: J__Test_Coupled_Work Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class J__Test_Coupled_Work implements TalendJob {
	...
	private final String jobName = "J__Test_Coupled_Work";
	private final String projectName = "PAOLOHATORTO";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					J__Test_Coupled_Work.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(J__Test_Coupled_Work.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("ciao picchio");
	...
	public static void main(String[] args) {
		final J__Test_Coupled_Work J__Test_Coupled_WorkClass = new J__Test_Coupled_Work();

		int exitCode = J__Test_Coupled_WorkClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = J__Test_Coupled_Work.class.getClassLoader().getResourceAsStream(
					"paolohatorto/j__test_coupled_work_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = J__Test_Coupled_Work.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : J__Test_Coupled_Work");
		}
...
/************************************************************************************************
 * 28327 characters generated by Talend Open Studio for Big Data on the 11
 * giugno 2020 16.37.10 CEST
 ************************************************************************************************/